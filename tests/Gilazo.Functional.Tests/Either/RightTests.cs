...
namespace Gilazo.Functional
{
	public class RightTests
	{
		...
		public void Bind_IsRight_RightFuncsInvoked(string initial)
		{
			...
			Either<int, string> AppendComma(string value) => $"{value},";
			Either<int, string> AppendSpace(string value) => $"{value} ";
			Either<int, string> AppendWorld(string value) => $"{value}World";
